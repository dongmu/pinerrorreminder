...
mod handlers {
    ...
    pub(crate) mod pin_consistency;
    pub(crate) mod pin_drop_analysis;
    pub(crate) mod pin_misuse;
    pub(crate) mod pin_unpin_analysis;
...
pub fn semantic_diagnostics(
    ...
    // ad-hoc syntactic walkers for pin diagnostics
    res.extend(handlers::pin_misuse::pin_misuse(&ctx, editioned_file_id));
    res.extend(handlers::pin_consistency::pin_consistency(&ctx, editioned_file_id));
    res.extend(handlers::pin_unpin_analysis::pin_unpina(&ctx, editioned_file_id));
